...
#define SH_MOD(x)       { SH_NONE(x); addBplMod(x); }
#define SH_MOD_ODD(x)   { SH_ODD(x);  addBplMod(x); }
#define SH_MOD_EVEN(x)  { SH_EVEN(x); addBplMod(x); }
#define SH_MOD_BOTH(x)  { SH_BOTH(x); addBplMod(x); }
